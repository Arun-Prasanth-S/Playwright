...
import com.lambdatest.pages.RegisterAccountPage;
...
public class RegisterUserTC extends PlaywrightConnection{
	...
	public void registerUSer() {
		...
		try {
			...
			String email = "Arun"+new Date().getTime()+"@mail.com";
			register.registerUserAccount("Arun Prasanth", "S",email, "1234567890", "Pass@123");
